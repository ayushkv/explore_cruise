...
var minDate = new Date(parseInt(currentDate.getFullYear(), 10), parseInt(currentDate.getMonth(), 10), parseInt(currentDate.getDate(), 10));
//var maxDate = new Date(parseInt(currentDate.getFullYear(), 10), (parseInt(currentDate.getMonth(), 10) ) + 11, parseInt(currentDate.getDate(), 10));
...
//   $('ul.main-nav li a[href="'+ location +'"]').parent().addClass('active').siblings().removeClass('active');


  $('.close').on('click', function(){
    $('body').removeClass('overflow-hidden');
    $('.overlay').removeClass('overlay_active');
    $('.Thanku-alert').removeClass('active');
  })
