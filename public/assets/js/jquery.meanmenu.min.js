...
! function(e) {
    ...
    $('.mobmenu_info').attr('href', 'tel:' + phoneNumber).text(phoneNumber);
        ...
        return this.each(function() {
            ...
            var M = "",
                ...
                E = function() {
                    ...
                    if (t <= o) {
                        jQuery(f).addClass("mean-remove"), A = !0, jQuery(a).addClass("mean-container"), jQuery(".mean-container").prepend('<div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="' + n + '">Show Navigation</a><nav class="mean-nav"></nav><div class="me-3"> <a  href="tel:' + phoneNumber + '" class="btn btn-primary mobmenu_info call-white"> <i class="isax isax-call-calling5 fs-24"></i>' + phoneNumber + '</a> </div></div>');
                        var u = jQuery(e).html();
