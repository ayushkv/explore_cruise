...
<?php $seo_data = App\Http\Controllers\HomeController::meta_info(10); ?>
@section('title')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Cruise Booking</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('index') }}"><i class="isax isax-home5"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Cruise Booking</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
               <div class="card">
                ...
                <h6 class="text-primary fs-14 fw-medium mb-2">Cruise Booking</h6>
                <h2 class="display-6 mb-2">Unforgettable Cruise Experiences</h2>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <p>Our customers primarily book cruises to various popular destinations around the world, with a special focus on the Caribbean, Mediterranean, and Asia. Whether it's sandy beaches, vibrant city life, or exotic cultures, we offer cruises that cater to every interest.</p>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <p>We partner with leading cruise lines to offer the best prices and exclusive packages for a wide range of cruises, from luxury liners to family-friendly adventures. Our curated selection ensures you enjoy the best of the seas, with premium amenities, entertainment, and unforgettable experiences.</p>
                </div>
            </div>
            <div class="about-mission">
                <p class="fs-16 text-gray-6">Our mission is to make booking cruises as easy and enjoyable as the cruise itself. We strive to offer an intuitive platform with personalized recommendations, ensuring you have a stress-free booking process and an unforgettable journey at sea. Whether it's your first cruise or you're a seasoned traveler, we are here to make your dreams set sail!</p>
            </div>
